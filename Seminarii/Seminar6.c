...
struct ListaDubla { //mem capul si coada listei
	Nod* head;
	Nod* tail;
};
...
void inserareInceput(ListaDubla* listaDubla, Biblioteca b) { //la inserareFinal este in oglinda: inlocuim head cu tail,prev cu next
...
//calcul nr carti total cu parcurgere de la final la inceput
